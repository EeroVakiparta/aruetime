package com.arue.aruetime.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.arue.aruetime.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.arue.aruetime.repository.UserRepository.USERS_BY_EMAIL_CACHE);
