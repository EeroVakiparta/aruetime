...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './arue-man.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARUEMAN_LIST actions', async () => {
    ...
    it('dispatches FETCH_ARUEMAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ARUEMAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ARUEMAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ARUEMAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ARUEMAN actions', async () => {
      const expectedActions = [
        {
