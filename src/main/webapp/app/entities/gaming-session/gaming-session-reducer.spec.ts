...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GAMINGSESSION_LIST actions', async () => {
    ...
    it('dispatches FETCH_GAMINGSESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GAMINGSESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GAMINGSESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GAMINGSESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GAMINGSESSION actions', async () => {
      const expectedActions = [
        {
