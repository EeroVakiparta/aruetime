...
import com.arue.aruetime.repository.GameRepository;
...
class GameResourceIT {
    ...
    public static Game createEntity(EntityManager em) {
        Game game = new Game().gameName(DEFAULT_GAME_NAME).popularity(DEFAULT_POPULARITY);
        return game;
    }
    ...
    public static Game createUpdatedEntity(EntityManager em) {
        Game game = new Game().gameName(UPDATED_GAME_NAME).popularity(UPDATED_POPULARITY);
        return game;
    }
    ...
    void createGame() throws Exception {
        ...
        assertThat(testGame.getPopularity()).isEqualTo(DEFAULT_POPULARITY);
    }
    ...
    void putNewGame() throws Exception {
        ...
        updatedGame.gameName(UPDATED_GAME_NAME).popularity(UPDATED_POPULARITY);
        ...
        assertThat(testGame.getPopularity()).isEqualTo(UPDATED_POPULARITY);
    }
    ...
    void fullUpdateGameWithPatch() throws Exception {
        ...
        partialUpdatedGame.gameName(UPDATED_GAME_NAME).popularity(UPDATED_POPULARITY);
